...
/* Q5: How can you produce a list of faci lities, with each labelled as
...
SELECT CONCAT(firstname, " ", surname) AS membername
FROM Bookings
INNER JOIN Facilities ON Bookings.facid = Facilities.facid
INNER JOIN Members ON Bookings.memid = Members.memid
WHERE name LIKE "Tennis Court%" 
	AND first name != GUEST
